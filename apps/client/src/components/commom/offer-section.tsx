...
const OfferSection = ({ title, offers, ...props }: { title: string; offers: Offer[] }) => {
  return (
    <div className="w-full flex flex-col gap-4">
      <h2 className="text-xl font-semibold">À la une aujourd'hui</h2>
      <Carousel className="w-full" opts={{
        ...
        <CarouselPrevious className='left-4 top-1/3 shadow-lg' />
        <CarouselNext className='right-4 top-1/3 shadow-lg' />
      </Carousel>
    </div>
  );
};
